...
def init():
    ...
    click.echo()
    click.echo(click.style('[d2s]', bold=True) + ' Download GraphDB version 8.10.1 standalone zip distribution at ' + click.style('https://ontotext.com/products/graphdb/', bold=True))
    click.echo()
